...
<figure><img src="../../.gitbook/assets/image (21).png" alt="" width="374"><figcaption></figcaption></figure>
...
[The syllabus is here](https://docs.google.com/document/d/1TCDIejtCQ1suxZ6w5pR9Hr7D_CrhWDAt/edit?usp=sharing\&ouid=100179871492576617561\&rtpof=true\&sd=true), also under the "Resources" module of Canvas (The first module).

## <mark style="color:orange;">"\[gr] Getting ready for the class" assignments ("Week 1" Module)</mark> <a href="#getting-ready-for-the-class-module-assignments" id="getting-ready-for-the-class-module-assignments"></a>

There are two assignments to get ready for the class. You can find these assignments under the "Week 1" module.

Feel free to submit assignments during the break if you wish. I will grade the assignments in 24 hours during the break.

{% stepper %}
{% step %}
**\[gr] Google Drive assignment (must be submitted first)** <mark style="color:red;">(due by 06/01 - 11:59 pm)</mark>

* Unlike other assignments, this assignment comes with unlimited attempts.
* There is a video instruction for this assignment.
* This assignment needs to be submitted first. When graded, you will receive a notification email with feedback. Follow the feedback and resubmit it until you receive at least 70 within the deadline.&#x20;
* Without getting at least 70 from the “Google Drive Assignment”, students cannot continue the course.
{% endstep %}

{% step %}
**\[gr] Submitting assignments practice (must be submitted second)**  <mark style="color:red;">(due by 06/02 - 11:59 pm)</mark>

* Unlike other assignments, this assignment comes with unlimited attempts too.
...
* DO NOT submit this assignment before getting at least 70 from the "\[gr] Google Drive assignment (the assignment that must be submitted first)" assignment.
{% endstep %}
{% endstepper %}
...
Below is a sample overview from SOC399 class, which includes five lectures for Week 3:

1. Social identity of immigrants
2. Migrant networks
3. Grandparental involvement
4. Intergenerational relationships
5. The sociology of border

Each lecture is accompanied by one assignment (indented items are assignments associated with the specific lectures above):

<figure><img src="../../.gitbook/assets/SCR-20260521-lgep-2.png" alt=""><figcaption></figcaption></figure>
...
<figure><img src="../../.gitbook/assets/SCR-20251219-hxst.png" alt="" width="512"><figcaption></figcaption></figure>
...
<figure><img src="../../.gitbook/assets/SCR-20260521-ljnc-2.png" alt=""><figcaption></figcaption></figure>
...
3. &#x20;"Available until" information:
   1. For this sample assignment, the due date is Jun 16 - 11:59:00pm.
   2. After the deadline has passed, students can submit this assignment by Jun 17 - 11:59:00pm without a deduction <mark style="color:red;">(1 day late; no deduction)</mark>.&#x20;
   3. If submitted by  Jun 18 - 11:59:00pm, the maximum grade could be 90 <mark style="color:red;">(2 days late; 10% deduction)</mark>.&#x20;
   4. If submitted by  Jun 19 - 11:59:00pm, the maximum grade could be 85 <mark style="color:red;">(3 days late; 15% deduction)</mark>.
   5. If submitted by  Jun 20 - 11:59:00pm, the maximum grade could be 80 <mark style="color:red;">(4 days late; 20% deduction)</mark>.&#x20;
...
1. **Lecture assignments (100%)**: Each lecture comes with an assignment.
